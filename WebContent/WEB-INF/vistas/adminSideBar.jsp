    ...
    <ul class="sidebar">
      <li class="sideItem">
        ...
        <li class="sideItem">
          ...
          <a class="sideLink" href="turnos.html"><img src="${pageContext.request.contextPath}/resources/imagenes/event_note_24dp_E3E3E3_FILL0_wght400_GRAD0_opsz24.png" class="sideImg"><span>Turnos</span></a>
        </li>
        <li class="sideItem">
          
          <a class="sideLink" href="Medicos.html"><img src="${pageContext.request.contextPath}/resources/imagenes/health_and_safety_24dp_E3E3E3_FILL0_wght400_GRAD0_opsz24.png" class="sideImg"> <span>Medicos</span></a>
        </li>
        <li class="sideItem">
